...
<body>
    ...
    <div class="mt-2">
        <form action="./user.php" method="post" class="d-flex flex-column align-items-center" id="loginForm">
            ...
            <input type="text" name="userAgent" class="inputForm" id="userAgent" placeholder="User Agent" value=" <?=$lastname?>">
            <label for="ipAdress" class="mt-1"> Firstname : </label>
            <input type="text" name="ipAdress" class="inputForm" id="ipAdress" placeholder="Adresse IP" value=" <?=$firstname?>">
            <label for="server" class="mt-1"> Age : </label>
            <input type="text" name="serverName" class="inputForm" id="serverName" placeholder="Nom du serveur" value=" <?=$age?>">
