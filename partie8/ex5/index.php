    ...
    <div class="mt-2">
        <form action="../ex4/user.php" method="post" class="d-flex flex-column align-items-center" id="loginForm">
            ...
            <label for="hidden" class="mt-1">
                EX 5 : Faire une page qui va pouvoir modifier le contenu du cookie de l'exercice 3.
            </label>
            <input type="text" name="hidden" id="hidden" class="inputForm" value="" hidden readonly>
            <label for="loginUser" class="mt-1"> Login : </label>
            <input type="text" name="loginUser" class="inputForm" id="loginUser" placeholder="User Agent" value="<?=$loginUser?>">
            <label for="passwordUser" class="mt-1"> Password : </label>
            <input type="password" name="passwordUser" class="inputForm" id="passwordUser" placeholder="Adresse IP" value="<?=$passwordUser?>">
