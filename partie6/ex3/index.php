...
// Instructions
// Test que les paramètres 'lastname' et 'firstname' existent et sont non vide avec EMPTY
if (!empty($_GET['startDate'] && !empty($_GET['endDate']))) {
    $message = 'start : ' . $_GET['startDate'] . ' end : ' . $_GET['endDate'];
}
