...
$aString = 'Chaîne de caractères';
// Déclarations des fonctions
function concat($num, $justString)
{
    $message = $num . ' ' . $justString;
    return $message;
}
$result = concat($number, $aString);
    ...
    <div class="mt-2">
        <form action="#" method="get" class="d-flex flex-column align-items-center" id="loginForm">
            ...
            <label for="text" class="mt-1"> 
                EX 5 : Faire une fonction qui prend en 
                paramètre un nombre et une chaine de 
                caractères et qui renvoit la concaténation 
