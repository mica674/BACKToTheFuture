...
function stringsTogether($justString1, $justString2)
{
    return $justString1.$justString2;
}
?>
    ...
    <div class="mt-2">
        <form action="#" method="get" class="d-flex flex-column align-items-center" id="loginForm">
            ...
            <label for="text" class="mt-1"> 
                EX 3 : Faire une fonction qui prend en paramètre
                deux chaines de caractères et qui renvoit 
                la concaténation de ces deux chaines.
            </label>
            <input type="text" name="age" id="age" class="inputForm" placeholder="age" 
            value="<?= stringsTogether(12, 40); ?>" readonly>
        </form>
    </div>
    <!-- Form end -->
