...
echo 'Nombre de jour : ' . date('d', mktime(0,0,0,3,0,16));
echo ' Nombre de jour : ' . $numberDay;
?>
    ...
    <div class="mt-2">
        <form action="#" method="get" class="d-flex flex-column align-items-center" id="loginForm">
            ...
            <label for="hidden" class="mt-1">
                EX 6 : Afficher le nombre de jour 
                    dans le mois de février de l'année 2016.
            </label>
